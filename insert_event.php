...
include('header.php');
  ...
  if(isset($_POST['insertEvent'])){
    ...
    // var_dump($_POST);
    $db->insert_Event($_POST['name'], $_POST['datestart'], $_POST['dateend'], $_POST['NumberAllowed'], $_POST['dropdown'], $_SESSION['userRole']);
...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
        <a class="navbar-brand col-md-3 col-lg-2 mr-0 px-3" href="#">Add Events</a>
          ...
          <ul class="navbar-nav px-3">
              <li class="nav-item text-nowrap">
                <a class="nav-link" href="insert_event.php?logout=true">Logout</a>
              </li>
          </ul>
        </nav>
                  ...
                  <div class="col-lg-8 push-lg-4 personal-info"> 
                    <?php 
                        ...
                        $result = $db->get_Venues();
                          //var_dump($result);
                        echo'<form action="" method="post" role="form" id="createAccountFor" > 
                            ...
                            <label class="col-lg-3 col-form-label form-control-label">Name</label>
                                ...
                                echo  '<button class="btn btn-primary" type="submit" name="insertEvent">Submit</button>'; 
                    echo '<hr/></form>';  
                    ?>
                    </div>
                  </div>
