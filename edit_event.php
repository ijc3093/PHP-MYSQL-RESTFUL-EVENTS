<?php
    ...
    if(isset($_POST['edit'])){
        ...
        // pass the result to class
        $hold = $db->update_event($_POST['name'], $_POST['datestart'],  $_POST['dateend'] , $_POST['numberAllowed'], $_POST['dropdown'] , $_POST['id'] );
        // var_dump($hold);
        if($hold){
            echo "<script>alert('Event updated');</script>";
        }else{
            echo "<script>alert('Event failed to save');</script>";
        }
    }
                                ...
                                <?php
                                        ...
                                        echo'<form action="" method="post" role="form">';
                                            ...
                                            echo'<div class="form-group row">';
                                                    ...
                                                    echo $venue . ' <br><br><a href="events.php?back=true" class="btn btn-secondary" class="form-control" value="Cancel" required>Back</a>
